...
import WebApplication.AirBnb.service.NguoiDungBLL;

@Service
public class NguoiDungServiceImpl implements NguoiDungBLL{
	@Autowired
	...
	@Override
	public List<NguoiDung> findAllById(Iterable<Long> ids) {
