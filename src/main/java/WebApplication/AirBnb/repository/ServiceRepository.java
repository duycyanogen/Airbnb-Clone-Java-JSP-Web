...
//	@Query(value = "select new WebApplication.AirBnb.model.ServiceDto(s.service_id, s.service_name, s.icon) from room_type_infos as r, service_details as sd, services as s where r.room_type_info_id = sd.room_type_info_room_type_info_id and sd.service_service_id = s.service_id and r.room_type_info_id = ?1", nativeQuery = true)
