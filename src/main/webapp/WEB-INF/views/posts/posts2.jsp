					...
					<div class="container-content-item">
						<div class="content-item-block">
							<div class="content-img">
								<img src="${pageContext.request.contextPath}/roomimage/${item.getLstImages().get(0)}" alt="">
							</div>
							<div class="content-info">
								...
								<div class="content-info-detail">
									<p>
										.${item.getLstRoomTypeInfos().get(0).getRoomType().getRoomTypeName()} .
										${item.getLstRoomTypeInfos().get(0).getLstBedTypeDetails().get(0).getBedType().getBedTypeName()}
										<c:forEach items="${item.getLstRoomTypeInfos().get(0).getLstServiceDetails()}"
											var="serviceName">
									...
									<div class="content-info-detail-end">
										<div class="info-evalution">
											...
											<p class="star-point">${item.getLstImages().get(0)}</p>
											<p class="star-number">(${item.getLstImages().get(0)} đánh
												giá)</p>
										</div>
										<div class="info-price">
											<fmt:setLocale value="vi_VN" />
											
											<p class="info-price-number"><fmt:formatNumber value="${item.getLstRoomTypeInfos().get(0).getPrice()}" type="currency" /></p>
