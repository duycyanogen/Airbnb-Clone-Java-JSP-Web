...
<link rel="stylesheet" type="text/css"
	href="<c:url value='css/posts/posts.css'/>" />
<link rel="stylesheet" type="text/css"
					...
					<div class="container-content-item">
						<div class="content-item-block">
							<div class="content-img">
								<img src="roomimage/${item.getImage1()}" alt="">
							</div>
							<div class="content-info">
								...
								<div class="content-info-detail">
									<p>.${item.getRoomTypeName()} .${item.getBedTypeName()}
										<c:forEach items="${item.getLstServiceNames()}" var="serviceName">
										. ${serviceName}
										</c:forEach>
										</p>
									<div class="content-info-detail-end">
										<div class="info-evalution">
											...
											<p class="star-number">(${item.getRatingAmount()} đánh giá)</p>
										</div>
										<div class="info-price">
											<p class="info-price-number">vnđ ${item.getPrice()}</p>
