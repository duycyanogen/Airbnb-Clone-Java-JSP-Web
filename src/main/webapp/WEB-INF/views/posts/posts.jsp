		...
		<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
			<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
				...
				<head>
					...
					<link rel="stylesheet" type="text/css" href="<c:url value='css/posts/main.css'/>" />
					<link rel="stylesheet" type="text/css" href="<c:url value='css/posts/posts.css'/>" />
				...
				<body>
					...
					<div class="header">
						<div class="logo-frame">
							<div class="_1grlqto">
								<a href="trang-chu" style="color: #ff385c;">
						...
						<div class="user-frame">
							...
							<c:if test="${ not empty sessionScope.LoginInfor }">
								<span>${sessionScope.LoginInfor.getMail() }</span>
							</c:if>
							...
							<div class="container-content">
									...
									<div class="content-item-block">
										...
										<div class="content-info">
											<div class="content-info-title">
												<p>Toàn bộ căn hộ cho thuê tại quận 4</p>
											...
											<div class="content-info-detail">
												<p>2 khách .Phòng studio .1 giường .1 phòng tắm. . Bếp .Điều
													hòa nhiệt độ. Wifi . Máy giặt</p>
												<div class="content-info-detail-end">
													<div class="info-evalution">
														<i class="fas fa-star"></i>
														<p class="star-point">4,88</p>
														<p class="star-number">(176 đánh giá)</p>
													</div>
								...
								<div class="contaier-pagin">
									<ul>
										...
										<li class="page-link-item active-page"><a href="" class="active-link">1</a></li>
