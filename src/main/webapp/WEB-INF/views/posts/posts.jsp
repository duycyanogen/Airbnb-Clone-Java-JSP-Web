			...
			<div class="container-content">
				...
				<div class="contaier-pagin">
					<ul>
						...
						<li class="page-link-item"><a href="${pageContext.request.contextPath}/danh-sach-tin/?pageId=${paginateInfo.currentPage - 1}""> <i
								class="fas fa-chevron-circle-left"></i>
						</a></li>
						</c:if>
						<c:if test="${paginateInfo.currentPage == 1}">
						<li class="page-link-item"><a href="${pageContext.request.contextPath}/danh-sach-tin/?pageId=1""> <i
								class="fas fa-chevron-circle-left"></i>
						</a></li>
						</c:if>
						<c:forEach var="item" begin="${paginateInfo.totalPage - 3 < 1 ? 1 : paginateInfo.totalPage - 3 }"
							...
							<c:if test="${(loop.index) != paginateInfo.currentPage }">
								<li class="page-link-item"><a href="${pageContext.request.contextPath}/danh-sach-tin/?pageId=${loop.index}"
									class="active-link">${loop.index}</a></li>
							</c:if>
...
<!-- 							<li class="page-link-item"><a href="" class="">4</a></li> -->
						...
						<li class="page-link-item"><a href="${pageContext.request.contextPath}/danh-sach-tin/?pageId=${paginateInfo.currentPage + 1}" class=""> <i
								class="fas fa-chevron-circle-right"></i>
						</a></li>
						</c:if>
						<c:if test="${paginateInfo.currentPage == paginateInfo.totalPage}">
						<li class="page-link-item"><a href="${pageContext.request.contextPath}/danh-sach-tin/?pageId=${paginateInfo.currentPage}" class=""> <i
								class="fas fa-chevron-circle-right"></i>
						</a></li>
						</c:if>
