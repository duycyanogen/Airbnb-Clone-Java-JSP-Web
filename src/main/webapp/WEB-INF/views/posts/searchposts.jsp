...
<link rel="stylesheet" type="text/css"
	href="<c:url value='${pageContext.request.contextPath}/css/posts/main.css'/>" />
<link rel="stylesheet" type="text/css"
	href="<c:url value='${pageContext.request.contextPath}/css/posts/posts.css'/>" />
<link rel="stylesheet" type="text/css"
	...
	<div class="container">
		<div class="container-main">
			...
			<div class="container-content">
				<p class="container-content-title">Danh sách khách sạn và thông
					tin</p>
				...
				<div class="contaier-pagin">
					<ul>
						...
						<li class="page-link-item"><a href="${pageContext.request.contextPath}/danh-sach-tin/tim-kiem?pageId=${paginateInfo.currentPage - 1}""> <i
								class="fas fa-chevron-circle-left"></i>
						</a></li>
						</c:if>
						<c:if test="${paginateInfo.currentPage == 1}">
						<li class="page-link-item"><a href="${pageContext.request.contextPath}/danh-sach-tin/tim-kiem?keyword=${keyword}&pageId=1""> <i
								class="fas fa-chevron-circle-left"></i>
						</a></li>
						</c:if>
						<c:forEach var="item" begin="${paginateInfo.totalPage - 3 < 1 ? 1 : paginateInfo.totalPage - 3 }"
							...
							<c:if test="${(loop.index) == paginateInfo.currentPage }">
								<li class="page-link-item active-page"><a href="${pageContext.request.contextPath}/danh-sach-tin/tim-kiem?keyword=${keyword}&pageId=${loop.index}"
									class="active-link">${loop.index}</a></li>
							</c:if>
							<c:if test="${(loop.index) != paginateInfo.currentPage }">
								<li class="page-link-item"><a href="${pageContext.request.contextPath}/danh-sach-tin/tim-kiem?keyword=${keyword}&pageId=${loop.index}"
									class="active-link">${loop.index}</a></li>
							</c:if>
...
<!-- 							<li class="page-link-item"><a href="" class="">4</a></li> -->
						...
						<li class="page-link-item"><a href="${pageContext.request.contextPath}/danh-sach-tin/tim-kiem?keyword=${keyword}&pageId=${paginateInfo.currentPage + 1}" class=""> <i
								class="fas fa-chevron-circle-right"></i>
						</a></li>
						</c:if>
						<c:if test="${paginateInfo.currentPage == paginateInfo.totalPage}">
						<li class="page-link-item"><a href="${pageContext.request.contextPath}/danh-sach-tin/tim-kiem?keyword=${keyword}&pageId=${paginateInfo.currentPage}" class=""> <i
								class="fas fa-chevron-circle-right"></i>
						</a></li>
						</c:if>
