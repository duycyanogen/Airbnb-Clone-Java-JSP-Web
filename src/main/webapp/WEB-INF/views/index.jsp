<%@ page pageEncoding="utf-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="<c:url value='css/home/reset.css'/>" />
            <link rel="stylesheet" type="text/css" href="<c:url value='css/home/base.css'/>" />
            <link rel="stylesheet" type="text/css" href="<c:url value='css/home/total.css'/>" />
            ...
            <div class="container">
                <div class="slider">
                    <div class="slider__content">
                        <span class="slider__text">Bạn chưa biết nên đi đâu? Tuyệt!</span>
                ...
                <div class="section third-section">
                    <div class="img-abv img-abv--relative">
                        ...
                        <div class="third-section-content">
                            ...
                            <p class="sub-header-txt">Danh sách Yêu thích do AirBnb tuyển chọn.</p>
                ...
                <div class="section fourth-section">
                    <p class="section__header section__header--lite">Khám phá Trải nghiệm</p>
                    <p class="section-sub-header">Các hoạt động độc đáo với các chuyên gia địa phương –
                        tham gia trực tiếp hoặc trực tuyến.</p>
                    <div class="grid-row">
                            ...
                            <div class="experience-item">
                                ...
                                <div class="txt-und">
                                    <a href="#">
                                        ...
                                        <p>Các hoạt động tương tác, truyền trực tiếp dưới sự dẫn dắt của Người tổ chức.
                                        </p>
                                    </a>
                        ...
                        <div class="grid-column-3">
                            <div class="experience-item">
                                ...
                                <div class="txt-und">
                                    <a href="#">
                                        <h1>Trải nghiệm</h1>
                                        <p>Những điều nên trải nghiệm của địa phương, dù bạn đang ở bất cứ đâu.</p>
                                    </a>
                ...
                <div class="section fifth-section">
                    <div class="img-abv img-abv--relative">
                        ...
                        <div class="third-section-content">
                            ...
                            <p class="sub-header-txt negative">Kiếm thêm thu nhập và khám phá các cơ hội mới bằng cách
                                chia sẻ
                                nơi ở của bạn.</p>
