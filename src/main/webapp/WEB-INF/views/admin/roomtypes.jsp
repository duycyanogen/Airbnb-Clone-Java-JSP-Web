												...
												<tr>
													...
													<td>
														...
														<button class="btn btn-info"
															onclick="showUpdateDialog(${item.getRoomTypeId()},'${item.getRoomTypeName()}')">Sửa</button>
													</td>
												</tr>
											</c:forEach>
										</tbody>
			...
			<div class="overlay none-block">
				...
				<div id="confirm-delete" class="overlay-confirm">
					<div class="overlay-confirm-header">
						<p class="">Bạn có chắc chắn muốn xóa loại phòng này?</p>
				...
				<div id="confirm-insert" class="overlay-confirm">
					<form:form
						action="${pageContext.request.contextPath}/admin/insertRoomType"
						modelAttribute="roomTypeDto">
						<div class="overlay-confirm-header">
							<div class="input-form">
								<h2>Thêm mới loại phòng</h2>
								<form:input type="text" placeholder="Nhập tên loại phòng mới"
									path="roomTypeName" />
							</div>
							<i class="fas fa-times cancel"></i>
						</div>
				...
				<div id="confirm-update" class="overlay-confirm">
					<form:form
						action="${pageContext.request.contextPath}/admin/updateRoomType"
						modelAttribute="roomTypeDto">
						<div class="overlay-confirm-header">
							<div class="input-form">
								<h2>Chỉnh sửa</h2>
								<form:input id="Id" type="hidden" path="roomTypeId" />
								<form:input id="Name" type="text"
									placeholder="Nhập tên dịch vụ mới" path="roomTypeName" />
							</div>
							<i class="fas fa-times cancel"></i>
						</div>
						<div class="overlay-confirm-content">
...
// 							
							...
							const showUpdateDialog = function (serviceId, name) {
