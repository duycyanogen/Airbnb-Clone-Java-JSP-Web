												...
												<tr>
													...
													<td>
														...
														<button class="btn btn-info"
															onclick="showUpdateDialog(${item.getLocationId()},'${item.getLocationName()}')">Sửa</button>
													</td>
												</tr>
											</c:forEach>
										</tbody>
			...
			<div class="overlay none-block">
				...
				<div id="confirm-delete" class="overlay-confirm">
					<div class="overlay-confirm-header">
						<p class="">Bạn có chắc chắn muốn xóa địa điểm này?</p>
				...
				<div id="confirm-insert" class="overlay-confirm">
					<form:form
						action="${pageContext.request.contextPath}/admin/insertLocation"
						modelAttribute="locationDto">
						<div class="overlay-confirm-header">
							<div class="input-form">
								<h2>Thêm mới địa điểm</h2>
								<form:input type="text" placeholder="Nhập tên địa điểm mới"
									path="locationName" />
				...
				<div id="confirm-update" class="overlay-confirm">
					<form:form
						action="${pageContext.request.contextPath}/admin/updateLocation"
						modelAttribute="locationDto">
						<div class="overlay-confirm-header">
							<div class="input-form">
								<h2>Chỉnh sửa</h2>
								<form:input id="Id" type="hidden" path="locationId" />
								<form:input id="Name" type="text"
									placeholder="Nhập tên dịch vụ mới" path="locationName" />
							</div>
							<i class="fas fa-times cancel"></i>
						</div>
						<div class="overlay-confirm-content">
