        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <head>
                    ...
                    <link rel="stylesheet" type="text/css" href="<c:url value='css/account/grid.css'/>" />
                    <link rel="stylesheet" type="text/css" href="<c:url value='css/account/account.css'/>" />
                            ...
                            <div class="main-content row">
                                    ...
                                    <ul class="handle-info-list">
                                        <li class="handle-info-list-item name-account">
                                            <div>
                                                ...
                                                <input type="text" class="handle-value" value="${sessionScope.LoginInfor.getName()}">
                                            </div>
                                        ...
                                        <li class="handle-info-list-item sex-account">
                                            <div>
                                                ...
                                                <input type="text" class="handle-value" value="${sessionScope.LoginInfor.getSex()}">
                                            </div>
                                            <p class="handle-edit">Chỉnh sửa</p>
                                        </li>
                                        <li class="handle-info-list-item birthday-account">
                                            <div>
                                                ...
                                                <input type="date" class="handle-value" value="${sessionScope.LoginInfor.getDateOfBirth()}">
                                        ...
                                        <li class="handle-info-list-item mail-account">
                                            <div>
                                                ...
                                                <input type="text" class="handle-value" value="${sessionScope.LoginInfor.getMail()}" disabled>
                                        ...
                                        <li class="handle-info-list-item phone-account">
                                            <div>
                                                ...
                                                <input type="text" class="handle-value" value="${sessionScope.LoginInfor.getPhoneNumber()}">
                                        ...
                                        <li class="handle-info-list-item address-account">
                                            <div>
                                                ...
                                                <input type="text" class="handle-value" value="${sessionScope.LoginInfor.getAddress()}">
                                ...
                                <div class="additional-info col l-4">
                                    <ul class="additional-info-list">
                                        ...
                                        <span>Không thể thay đổi thông tin mà Airbnb sử dụng để xác minh danh tính của
                                            bạn. Bạn có thể
                                            chỉnh sửa thông tin liên hệ và một số thông tin cá nhân, nhưng chúng tôi có
                                            thể yêu cầu bạn
                                            xác minh danh tính vào lần tới khi bạn đặt phòng hoặc tạo mục cho
                                            thuê.</span>
                                    </ul>
                                    <ul class="additional-info-list">
                                        <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true"
                                        ...
                                        <span>Airbnb chỉ tiết lộ thông tin liên lạc cho chủ nhà và khách sau khi đặt
                                            phòng được xác
                                            nhận.</span>
                                    </ul>
                                </div>
